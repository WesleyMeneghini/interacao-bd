        ...
        <div id="container_formulario">
            <div class="conteudo center">
                <div id="formulario" class="center">
                    ...
                    <!--  
                            Colocar o enctype e o method post é obrigatorio esses campos estarem setados     
                            method="post"
                    ...
                    <form 
                        ...
                        <div class="segura_input">
                            ...
                            <input type="file" name="fle_foto" class="dados_cadastro" accept="image/jpg, image/png">
                        </div>
                        ...
                        <div id="foto_perfil" class="center">
                            <img src="bd/arquivos/<?=$nomeFoto?>" class="bkg-img cicle-image-view">
                        </div>
            ...
            <div class="conteudo center">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="bd/arquivos/<?=$rsContatos['foto']?>" class="img-td"> 
                        </td>
                        <td>
                            ...
                            <div class="icone_consulta">
                                <a onclick="return confirm('Deseja realmente excluir esse registro?')" 
                                   href="bd/deletar.php?modo=excluir&codigo=<?=$rsContatos['codigo']?>&foto=<?=$rsContatos['foto']?>">
